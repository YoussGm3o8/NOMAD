...
Write-Host "  pixi run build-plugin-only  Compile plugin without deployment (Windows)"
Write-Host "  pixi run build-plugin       Deploy plugin (Windows; changes Mission Planner installation)"
